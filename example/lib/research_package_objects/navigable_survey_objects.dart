...
RPChoiceAnswerFormat who5AnswerFormat =
    RPChoiceAnswerFormat.withParams(ChoiceAnswerStyle.SingleChoice, who5Choices, asset_path: 'assets/images/owl-3.jpg');
RPChoiceAnswerFormat joyfulActivitiesAnswerFormat =
    RPChoiceAnswerFormat.withParams(ChoiceAnswerStyle.MultipleChoice, joyfulActivities, asset_path: 'assets/images/owl-3.jpg');
RPChoiceAnswerFormat numbersAnswerFormat =
    RPChoiceAnswerFormat.withParams(ChoiceAnswerStyle.MultipleChoice, numbers, asset_path: 'assets/images/owl-3.jpg');
RPChoiceAnswerFormat alphabetAnswerFormat =
    RPChoiceAnswerFormat.withParams(ChoiceAnswerStyle.MultipleChoice, alphabet, asset_path: 'assets/images/owl-3.jpg');
RPChoiceAnswerFormat instrumentsAnswerFormat =
    RPChoiceAnswerFormat.withParams(ChoiceAnswerStyle.SingleChoice, instruments, asset_path: 'assets/images/owl-3.jpg');
...
RPChoiceAnswerFormat guitarAnswerFormat =
    RPChoiceAnswerFormat.withParams(ChoiceAnswerStyle.MultipleChoice, guitarReasons, asset_path: 'assets/images/owl-3.jpg');
...
RPChoiceAnswerFormat likertProblemScaleAnswerFormat =
    RPChoiceAnswerFormat.withParams(ChoiceAnswerStyle.SingleChoice, likertProblemScaleAnswers, asset_path: 'assets/images/owl-3.jpg');
